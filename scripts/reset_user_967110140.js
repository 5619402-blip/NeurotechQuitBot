// RESET тестового пользователя 967110140.
// Запуск только с флагом: node scripts/reset_user_967110140.js --confirm-reset-967110140
require('dotenv').config();
const db = require('../src/db/connection');

const TELEGRAM_ID = '967110140';
const CONFIRM_FLAG = '--confirm-reset-967110140';
...
async function run() {
  if (!process.argv.includes(CONFIRM_FLAG)) {
    ...
    console.log('');
    console.log('    node scripts/reset_user_967110140.js --confirm-reset-967110140');
    console.log('');
    console.log('  Внимание: операция необратима. Все данные пользователя 967110140 будут удалены.');
    return;
  }
